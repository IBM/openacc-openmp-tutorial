...
#define MAX_NUM_DESCENDANTS 16384
#define MAX_NUM_ENEMIES 16384
...
struct leader_data {
	...
	int num_descendants;         // number of descendants being led
	int num_enemies;             // number of enemies to attack
	int descendants[MAX_NUM_DESCENDANTS]; // list of descendant-indices in insects[]
	int enemies[MAX_NUM_ENEMIES]; // list of enemy-indices in insects[]
};
